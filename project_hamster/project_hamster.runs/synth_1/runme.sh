...
HD_PWD='C:/VivadoProjects/project_hamster/project_hamster.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log adau1761_test.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source adau1761_test.tcl
