...
HD_PWD='C:/VivadoProjects/QPSKBlock2/QPSKBlock2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log QPSK.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source QPSK.tcl
