...
HD_PWD='C:/VivadoProjects/QPSKBlock2/QPSKBlock2.runs/fifo_gen_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fifo_gen.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fifo_gen.tcl
