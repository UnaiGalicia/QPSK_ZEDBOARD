...
HD_PWD='C:/VivadoProjects/QPSKBlock2/QPSKBlock2.runs/axi4stream_vip_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log axi4stream_vip_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source axi4stream_vip_0.tcl
