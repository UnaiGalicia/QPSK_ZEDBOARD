...
proc create_root_design { parentCell } {
  ...
  # Create instance: HamsterB_0, and set properties
  set HamsterB_0 [ create_bd_cell -type ip -vlnv Unai:user:HamsterB:1.0 HamsterB_0 ]

  # Create instance: QPSKBlockIP_0, and set properties
  set QPSKBlockIP_0 [ create_bd_cell -type ip -vlnv Unai:user:QPSKBlockIP:1.0 QPSKBlockIP_0 ]
  ...
  # Create instance: rst_ps7_0_48M, and set properties
  set rst_ps7_0_48M [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 rst_ps7_0_48M ]

  # Create interface connections
  connect_bd_intf_net -intf_net processing_system7_0_DDR [get_bd_intf_ports DDR] [get_bd_intf_pins processing_system7_0/DDR]
  connect_bd_intf_net -intf_net processing_system7_0_FIXED_IO [get_bd_intf_ports FIXED_IO] [get_bd_intf_pins processing_system7_0/FIXED_IO]
  connect_bd_intf_net -intf_net processing_system7_0_M_AXI_GP0 [get_bd_intf_pins processing_system7_0/M_AXI_GP0] [get_bd_intf_pins ps7_0_axi_periph/S00_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins QPSKBlockIP_0/S01_AXI] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]

  # Create port connections
  connect_bd_net -net AC_GPIO1_0_1 [get_bd_ports AC_GPIO1_0] [get_bd_pins HamsterB_0/AC_GPIO1]
  connect_bd_net -net AC_GPIO2_0_1 [get_bd_ports AC_GPIO2_0] [get_bd_pins HamsterB_0/AC_GPIO2]
  connect_bd_net -net AC_GPIO3_0_1 [get_bd_ports AC_GPIO3_0] [get_bd_pins HamsterB_0/AC_GPIO3]
  connect_bd_net -net HamsterB_0_AC_ADR0 [get_bd_ports AC_ADR0_0] [get_bd_pins HamsterB_0/AC_ADR0]
  connect_bd_net -net HamsterB_0_AC_ADR1 [get_bd_ports AC_ADR1_0] [get_bd_pins HamsterB_0/AC_ADR1]
  connect_bd_net -net HamsterB_0_AC_GPIO0 [get_bd_ports AC_GPIO0_0] [get_bd_pins HamsterB_0/AC_GPIO0]
  connect_bd_net -net HamsterB_0_AC_MCLK [get_bd_ports AC_MCLK_0] [get_bd_pins HamsterB_0/AC_MCLK]
  connect_bd_net -net HamsterB_0_AC_SCK [get_bd_ports AC_SCK_0] [get_bd_pins HamsterB_0/AC_SCK]
  connect_bd_net -net HamsterB_0_TREADY [get_bd_pins HamsterB_0/TREADY] [get_bd_pins QPSKBlockIP_0/m01_axi_tready]
  connect_bd_net -net Net [get_bd_ports AC_SDA_0] [get_bd_pins HamsterB_0/AC_SDA]
  connect_bd_net -net QPSKBlockIP_0_m01_axi_tdata [get_bd_pins HamsterB_0/TDATA] [get_bd_pins QPSKBlockIP_0/m01_axi_tdata]
  connect_bd_net -net QPSKBlockIP_0_m01_axi_tvalid [get_bd_pins HamsterB_0/TVALID] [get_bd_pins QPSKBlockIP_0/m01_axi_tvalid]
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins HamsterB_0/ACLK] [get_bd_pins QPSKBlockIP_0/s01_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_48M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_48M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_48M_interconnect_aresetn [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins rst_ps7_0_48M/interconnect_aresetn]
  connect_bd_net -net rst_ps7_0_48M_peripheral_aresetn [get_bd_pins QPSKBlockIP_0/s01_axi_aresetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_48M/peripheral_aresetn]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs QPSKBlockIP_0/S01_AXI/S01_AXI_reg] SEG_QPSKBlockIP_0_S01_AXI_reg
