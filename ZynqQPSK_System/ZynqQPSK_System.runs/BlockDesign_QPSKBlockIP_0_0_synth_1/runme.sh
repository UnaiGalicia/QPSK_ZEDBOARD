...
HD_PWD='C:/VivadoProjects/ZynqQPSK_System/ZynqQPSK_System.runs/BlockDesign_QPSKBlockIP_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BlockDesign_QPSKBlockIP_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BlockDesign_QPSKBlockIP_0_0.tcl
